...
FLASH_IMG=$CURRENT_PATH/BUILD/GAP8_V2/GCC_RISCV/flash.img
...
#flashImageBuilder --verbose --flash-boot-binary=$BINARY --raw=$FLASH_IMG --comp=$CURRENT_PATH/BUILD/GAP8_V2/GCC_RISCV/flash.img
...
(
echo "gap8_jtag_load_binary_and_start $GAP_FLASHER_GAPOC elf"
sleep 2
echo "gap_flasher_ctrl $FLASH_IMG $FILESIZE 0 0x40000"
sleep 10
echo "reset"
sleep 1
echo "poll off"
